...
$repo = "delta-sim-grid-stack"
$language = "C#"
$category = "Simulations"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/delta-sim-grid-walkthrough.md")) {
