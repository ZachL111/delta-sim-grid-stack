...
`delta-sim-grid-stack` is centered on simulations work in C#. The technical target is: Create a C# reference implementation for grid workflows, centered on security rule linting, safe and unsafe fixtures, and remediation hints.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 7, latency has a penalty of 2, and weight contributes a bonus of 3.
