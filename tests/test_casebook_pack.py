"""Regression checks for the delta-sim-grid-stack casebook."""
...
from casebook.harness import assert_expected, delta_sim_grid_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_sim_grid_stack_summary(), assert_expected())
